        ...
        <table class="content-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="color-blue"><div class="content-table__mobile_heading">Бесплатно</div>Free</td>
                    <td class="color-blue"><div class="content-table__mobile_heading">Время обработки</div>моментальное</td>
                    <td class="color-grey"><div class="content-table__mobile_heading">Лимит транзакции</div>Min 10€ / max 5,000€</td>
                </tr>
